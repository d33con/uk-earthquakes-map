  ...
  <Popover id="about-popover">
    ...
    <Popover.Body>
      <Row>
        ...
        <h6>Table</h6>
        <p>
          The table updates automatically and can be sorted by Date, Magnitude,
          Depth and Location
        </p>
        <p>
          Click a table row to zoom in to the earthquake&apos;s location on the
          map
        </p>
      </Row>
    </Popover.Body>
...
export default function AboutOverlay() {
  return (
    <OverlayTrigger
      ...
      overlay={popover}
    >
      <Button variant="primary" className="btn-about">
        ?
      </Button>
    </OverlayTrigger>
  );
